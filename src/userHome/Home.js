...
function Number({n}){
 ...
 const Hero = () => {
  ...
  return (
    <div id='userHome' className='lg:p-16 p-4 bg-gradient-to-br from-rose-400 to-white'>
      <div className='flex flex-col items-center'>
      <div className='lg:text-5xl text-2xl mt-24 font-semibold my-5 text-center w-[80%]'>
      {text.map((el, i) => (
        <motion.span
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
      ...
      <p className='text-xltext-center'>Personalized implementation sessions, responsive live event support, and actionable feedback calls with our business leaders.</p>
      </div>
      <div className='lg:flex justify-between items-center grid md:grid-cols-2 gap-3 md:ml-0 ml-20'>
      <div className='mt-12'>
